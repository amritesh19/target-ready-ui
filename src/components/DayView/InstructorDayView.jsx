...
const InstructorDayView = () => {
  ...
  const fetchData = async (date) => {
    try{
      const response = await axios.get(`http://localhost:8087/time_table/instructor/${id}/${date}`);
            ...
            <TableBody>
                ...
                return (
                    ...
                    <TableCell style={{ border: "1px solid black" }}>
                        ...
                        <div>
                            <p>
                            <strong>Class:</strong> {slotSchedule.className + slotSchedule.section}
                            &nbsp;&nbsp;&nbsp;
...
export default InstructorDayView;
